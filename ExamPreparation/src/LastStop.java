...
class LastStop {
    ...
    void main (String[] args) {
        ...
        List<Integer> paintings = Arrays.stream (scanner.nextLine ().split ("\\s+")).map (Integer::parseInt).collect (Collectors.toList ());
    ...
    private static
    void revers (List<Integer> paintings) {
    ...
    private static
    void insert (List<Integer> paintings, String[] tokens) {
    ...
    private static
    void switchNumbers (List<Integer> paintings, String[] tokens) {
    ...
    private static
    void hide (List<Integer> paintings, String[] tokens) {
    ...
    private static
    void change (List<Integer> paintings, String[] tokens) {
        int number    = Integer.parseInt (tokens[1]);
